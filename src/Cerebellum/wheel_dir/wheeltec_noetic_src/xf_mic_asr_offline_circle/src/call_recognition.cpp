...
#include <xf_mic_asr_offline_circle/Pcm_Msg.h>
#include <xf_mic_asr_offline_circle/Start_Record_srv.h>
#include <xf_mic_asr_offline_circle/Set_Awake_Word_srv.h>
...
int main(int argc, char *argv[])
{
    ...
    nh.serviceClient<xf_mic_asr_offline_circle::Get_Offline_Result_srv>("xf_asr_offline_node/get_offline_recognise_result_srv");

    /***修改唤醒词服务客户端创建***/
    //ros::ServiceClient Set_Awake_Word_client =
    //nh.serviceClient<xf_mic_asr_offline_circle::Set_Awake_Word_srv>("xf_asr_offline_node/set_awake_word_srv");
  ...
  /***请求修改唤醒词服务***/
    //xf_mic_asr_offline_circle::Set_Awake_Word_srv SetAwakeWord_srv;
  ...
  /***离线命令词识别服务参数设置***/
    xf_mic_asr_offline_circle::Get_Offline_Result_srv GetOfflineResult_srv;
