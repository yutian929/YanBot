...
def data_callback(gnss_msg, ndt_msg):
    ...
    gnss_data = {
        "nsec": gnss_t1,
        "x": gnss_msg.pose.position.x,
        "y": gnss_msg.pose.position.y,
        "z": gnss_msg.pose.position.z,
    }
    ndt_data = {
        "nsec": gnss_t1,
        "x": ndt_msg.pose.position.x,
        "y": ndt_msg.pose.position.y,
        "z": ndt_msg.pose.position.z,
    }
