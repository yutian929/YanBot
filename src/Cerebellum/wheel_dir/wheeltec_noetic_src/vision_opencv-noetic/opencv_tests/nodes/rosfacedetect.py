...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        dest="topic",
        type="str",
        help="Topic to find a face on, default %default",
    ...
    parser.add_option(
        ...
        dest="ctopic",
        type="str",
        help="Compressed topic to find a face on, default %default",
        default="/camera/rgb/image/compressed",
    )
    ...
    def detect_and_draw(imgmsg):
        ...
        if cascade:
            faces = cascade.detectMultiScale(
                small_img, haar_scale, min_neighbors, haar_flags, min_size
            )
    ...
    rospy.Subscriber(
        options.ctopic, sensor_msgs.msg.CompressedImage, compressed_detect_and_draw
    )
    rospy.spin()
