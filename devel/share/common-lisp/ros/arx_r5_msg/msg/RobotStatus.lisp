...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arx_r5_msg-msg:<RobotStatus> is deprecated: use arx_r5_msg-msg:RobotStatus instead.")))
...
(cl:defmethod end_pos-val ((m <RobotStatus>))
...
(cl:defmethod joint_pos-val ((m <RobotStatus>))
...
(cl:defmethod joint_vel-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arx_r5_msg-msg:joint_vel-val is deprecated.  Use arx_r5_msg-msg:joint_vel instead.")
  (joint_vel m))

(cl:ensure-generic-function 'joint_cur-val :lambda-list '(m))
(cl:defmethod joint_cur-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arx_r5_msg-msg:joint_cur-val is deprecated.  Use arx_r5_msg-msg:joint_cur instead.")
  (joint_cur m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotStatus>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%float64[6] end_pos~%~%float64[7] joint_pos~%float64[7] joint_vel~%float64[7] joint_cur~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotStatus)))
  "Returns full string definition for message of type 'RobotStatus"
  (cl:format cl:nil "std_msgs/Header header~%~%float64[6] end_pos~%~%float64[7] joint_pos~%float64[7] joint_vel~%float64[7] joint_cur~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotStatus>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'joint_cur) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
