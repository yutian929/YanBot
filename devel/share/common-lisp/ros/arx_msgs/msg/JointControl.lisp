...
(cl:defmethod cl:initialize-instance :after ((m <JointControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arx_msgs-msg:<JointControl> is deprecated: use arx_msgs-msg:JointControl instead.")))
