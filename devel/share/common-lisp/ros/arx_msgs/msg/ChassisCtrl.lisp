...
(cl:defmethod cl:initialize-instance :after ((m <ChassisCtrl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChassisCtrl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arx_msgs-msg:<ChassisCtrl> is deprecated: use arx_msgs-msg:ChassisCtrl instead.")))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <ChassisCtrl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arx_msgs-msg:vx-val is deprecated.  Use arx_msgs-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <ChassisCtrl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arx_msgs-msg:vy-val is deprecated.  Use arx_msgs-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'vz-val :lambda-list '(m))
(cl:defmethod vz-val ((m <ChassisCtrl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arx_msgs-msg:vz-val is deprecated.  Use arx_msgs-msg:vz instead.")
  (vz m))
